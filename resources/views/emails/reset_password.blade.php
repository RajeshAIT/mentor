                ...
                <table role="presentation"
                    ...
                    <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                        <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                             <span style="font-weight: bold; padding-top: 10px;"> Mentor APP </span>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="text-align: center;">
                                            @if($is_verified == 0)
                                            <a href="{{ route('emails.change_password',($test_message)) }}" class="btn">Reset your password</a>
                                            @else
                                                <a  class="btn-green">Password Changes Successfully</a>    
                                            @endif
