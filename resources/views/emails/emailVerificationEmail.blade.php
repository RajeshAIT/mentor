					...
					<tr>
						<td class="td" style="width:650px; min-width:650px; font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal;">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<!-- Logo -->
								<tr>
									<td bgcolor="#ffffff" class="p30-15 img-center" style="padding: 30px; border-radius: 20px 20px 0px 0px; font-size:0pt; line-height:0pt; text-align:center;"><a href="#" target="_blank"><img src="{{asset('dist/img/1024.png')}}" width="146" height="17" mc:edit="image_6" style="max-width:146px;" border="0" alt="" /></a></td>
								</tr>
								<!-- END Logo -->
							...
							<div mc:repeatable="Select" mc:variant="Section 1">
								<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#1e52bd">
									...
									<tr>
										<td class="p30-15-0" style="padding: 50px 30px 0px;" bgcolor="#1e52bd">
											<form action="{{ route('company.Verify', request('token')) }}" method="POST">
												@csrf
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td class="h5-center"style="color:white; font-family:'Raleway', Arial,sans-serif; font-size:16px; line-height:22px; text-align:center; padding-bottom:5px;"><div mc:edit="text_3">Mentor APP</div></td>
													</tr>
													<tr>
														<td class="h2-center"style="color:white; font-family:'Playfair Display', Times, 'Times New Roman', serif; font-size:32px; line-height:36px; text-align:center; padding-bottom:20px;"><div mc:edit="text_4">Email Verification Mail</div></td>
													</tr>
													<tr>
														<td class="text-center"style="color:white; font-family:'Raleway', Arial,sans-serif; font-size:14px; line-height:22px; text-align:center; padding-bottom:22px;"><div mc:edit="text_5"><input type="text" placeholder="Email" name="email" autofocus/></div></td>
													</tr>
													@if($company->verify == 1)
													<tr>
														<td align="center">
															<table border="0" cellspacing="0" cellpadding="0">
																<tr>
																	<td class="text-button-orange"style=" "><button Type="submit"  class="link-white"style="background:#e85711; color:#ffffff; text-decoration:none;font-family:'Kreon', 'Times New Roman', Georgia, serif; font-size:14px; line-height:18px; text-align:center; padding:10px 30px; border-radius:20px;">Verify Email</button></td>
																</tr>
															</table>
														</td>
													</tr>
