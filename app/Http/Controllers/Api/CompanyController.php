...
class CompanyController extends Controller
{
    ...
    // Company Record Detail
     
    public function companyindex(Request $request)
    {
        return $this->companyInterface->companyindex($request);
    }
    public function companydestroy($id)
    {
        return $this->companyInterface->companydestroy($id);
    }
    public function companyshow($id)
    {
        return $this->companyInterface->companyshow($id);
    }

    // Company show logo
    public function companylogo($id)
    {
        return $this->CompanyInterface->companylogo($id);
    }
